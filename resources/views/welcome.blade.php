...
<body>
    <ul>
        ...
        @endif
        <li>
            <a href="#seccion1" class="navegacion__enlace enlace">Visión</a>
        </li>
        <li>
    ...
    <header class="header">
        ...
        <div class="header__texto">
            <p><h1 class="no-margin">El Mejor Sitio de Música</h1></p>
            <h1>Escucha a tu cantante favorito y descarga la canción</h1>
        </div>
    ...
    <section class="Partes" id="seccion1">
        ...
        <div class="Division">
            ...
            <p>
            <br>
            Somos una plataforma de música cuya finalidad es hacer que las personas dispongan de la mejor 
			música del momento desde cualquier lugar donde estén, les brindamos herramientas y formas 
			de seleccionar y organizar la música que las personas deseen, por esto mismo nos definimos 
			como una pagina de música individual, la cual con la ayuda de 
    ...
    <section class="Partes" id="seccion2">
        ...
        <div class="Division" >
            ...
            Chávez Salado Francisco Javier <br>
    ...
    <br>
    <footer>
    <p>&copy 2021 X MUSIC. Todos los Derechos Reservados | Diseño por <a href="#" target="_blank">Los del X</a></p>			
    </footer>
</body>
</html>